...
public final class form_005fgroupe_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("          $(\"#n\").change(function (){\n");
      out.write("              $.ajax({\n");
      out.write("                  url: \"nomgroup.jsp\",\n");
      out.write("                  data: {f: $(\"#f\").val(), n: $(\"#n\").val()},\n");
    ...
    List<Filieres> f=(List<Filieres>) request.getAttribute("filieres");
    List<Niveaux> n=(List<Niveaux>) request.getAttribute("niveaux");
      ...
      out.write("                  <h4 class=\"card-title\">Ajouté Groupe</h4>\n");
      out.write("                  <p class=\"card-description\">\n");
      out.write("                     \n");
      out.write("                  </p>\n");
      out.write("                  <form class=\"forms-sample\" action=\"");
      out.print(request.getContextPath());
      out.write("/ajouterGroupe\" method=\"post\">\n");
      out.write("                    <div class=\"form-group\">\n");
      out.write("                      <label for=\"exampleSelectGender\">id filiere</label>\n");
      out.write("                      <select class=\"form-control\" id=\"exampleSelectGender\" name=\"id_filiere\" id=\"f\">\n");
      out.write("                          ");
 for(int i=0;i<f.size() ;i++){ 
      out.write("\n");
      out.write("                          <option value=\"");
      out.print(f.get(i).getIdFiliere());
      out.write('"');
      out.write('>');
      out.print(f.get(i).getNomFiliere());
      out.write("</option>\n");
      out.write("                         ");
}
      out.write("\n");
      ...
      out.write("                      </div>\n");
      out.write("                      <div class=\"form-group\">\n");
      out.write("                      <label for=\"exampleSelectGender\">id niveau</label>\n");
      out.write("                      <select class=\"form-control\" id=\"exampleSelectGender\" name=\"id_niveau\" id=\"n\">\n");
      out.write("                          ");
 for(int i=0;i<n.size();i++){ 
      out.write("\n");
      out.write("                          <option value=\"");
      out.print(n.get(i).getIdNiveau());
      out.write('"');
      out.write('>');
      out.print(n.get(i).getNomNiveau());
      out.write("</option>\n");
      out.write("                         ");
}
      out.write("\n");
