        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Payement de mois</h4>
                  <p class="card-description">
                   
                  </p>
                  <form class="forms-sample" action="<%=request.getContextPath()%>/ajouterPaiement">
                    <div class="form-group row">
                      <div class="col-sm-9">
                        <div class="form-group">
                            <input type="text" name="cin" value="<%=request.getAttribute("c")%>" style="display: none"/>
                      <label>Mois</label>
