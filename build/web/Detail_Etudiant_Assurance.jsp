        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Payement d'assecance</h4>
                  <p class="card-description">
                   
                  </p>
                  <form class="forms-sample" action="<%=request.getContextPath()%>/ajouterAssurances">
                    <div class="form-group">
                        <input type="text" name="c" value="<%=request.getAttribute("c")%>" style="display: none"/>
                      <label>Validation</label>
                      <select class="form-control" id="asser" name="asser">
                          <option selected="" value="paye">paye</option>
