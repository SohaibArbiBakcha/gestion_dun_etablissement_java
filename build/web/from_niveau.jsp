    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          <div class="content-wrapper">             
              <div class="card-body">
                  <h4 class="card-title">Ajouté Niveau</h4>
                  <p class="card-description">
                   
                  </p>
                  <form class="forms-sample" action="<%=request.getContextPath()%>/ajouterNiveaux">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nom Niveau</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="nom Niveau" name="nom_niveau">
                    </div>
