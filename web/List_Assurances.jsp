...
<%
    List<Assurances> a=(List<Assurances>) request.getAttribute("list");
%>
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          <div class="content-wrapper">             
              ...
              <div class="card">
                <div class="card-body">
                    <form action="<%=request.getContextPath()%>/SearchAssurances">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Cin:</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Cin" name="cin">
                      <button type="submit" class="btn btn-primary mr-2" style="margin-top: 10px">Search</button>
                    </div>
                    </form>
                    <h4 class="card-title">Liste De Tous Les Assurances</h4>
